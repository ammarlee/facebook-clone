    ...
    <template>
      <div>
        <router-link to="/" tag="span" >
         <v-icon  style="cursor: pointer" large>mdi-facebook</v-icon>
        </router-link>
  ...
  methods: {
    async login(){
        ...
        "TokenUser=" + token + ";" + expires + ";path=/";
           ...
           this.$store.commit('setNotifications',currentUser.data.user.friendsNotifications)
           this.$store.commit('setAllNotificationsAfterLogin',currentUser.data.user.AllNotifications)
           this.$store.commit('setUserMessages',currentUser.data.user.messageNotifications)
